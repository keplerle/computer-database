				...
				<div class="pull-left">
					<form id="searchForm" action="dashboard" method="GET" class="form-inline">
						...
						<input type="search" id="searchbox" name="search"
							class="form-control" value='${search}' placeholder="<spring:message code="searchBar" />" /> <input
							type="submit" id="searchsubmit" value="<spring:message code="searchBarButton" />"
							class="btn btn-primary" />
					</form>
				</div>
				<div class="pull-right">
					<a class="btn btn-success" id="addComputer" href="add"><spring:message code="addComputer" /></a> 
						   <a class="btn btn-default" id="editComputer" href="#" onclick="$.fn.toggleEditMode();"><spring:message code="deleteButton" /></a>
				</div>
			</div>
		</div>
